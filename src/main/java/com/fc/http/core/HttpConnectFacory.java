...
public class HttpConnectFacory {
	 ...
	 * 
	 * @param schame
	 *            请求方式http/https 目前只支持http方式，默认为http
	 * @param domain
	 *            ip地址或者域名 比如www.baidu.com，默认为127.0.0.1
	 * @param port
	 *            端口,若无需要传null
	 * @param contextPath
	 *            请求上下文路径，若无需要传null
	 ...
	 * @throws IOException
	 */
	public static HttpConnect getHttpConnect(String schame, String domain, String port, String contextPath)
			throws IOException {
	...
	public static class HttpConnect {
		...
		public void sendRequest(String msg) {
			try {
				if (msg != null && "POST".equals(connect.getRequestMethod())) {
					if (out == null) {
